...
static const struct xlat_data v4l2_control_id_bases_xdata[] = {
 ...
 #define XLAT_VAL_15 ((unsigned) (V4L2_CID_CODEC_BASE))
 #define XLAT_STR_15 STRINGIFY(V4L2_CID_CODEC_BASE)
 XLAT(V4L2_CID_MPEG_CX2341X_BASE),
 #define XLAT_VAL_16 ((unsigned) (V4L2_CID_MPEG_CX2341X_BASE))
 #define XLAT_STR_16 STRINGIFY(V4L2_CID_MPEG_CX2341X_BASE)
 XLAT(V4L2_CID_MPEG_MFC51_BASE),
 #define XLAT_VAL_17 ((unsigned) (V4L2_CID_MPEG_MFC51_BASE))
 #define XLAT_STR_17 STRINGIFY(V4L2_CID_MPEG_MFC51_BASE)
 XLAT(V4L2_CID_CAMERA_CLASS_BASE),
 #define XLAT_VAL_18 ((unsigned) (V4L2_CID_CAMERA_CLASS_BASE))
 #define XLAT_STR_18 STRINGIFY(V4L2_CID_CAMERA_CLASS_BASE)
 XLAT(V4L2_CID_FM_TX_CLASS_BASE),
 #define XLAT_VAL_19 ((unsigned) (V4L2_CID_FM_TX_CLASS_BASE))
 #define XLAT_STR_19 STRINGIFY(V4L2_CID_FM_TX_CLASS_BASE)
 XLAT(V4L2_CID_FLASH_CLASS_BASE),
 #define XLAT_VAL_20 ((unsigned) (V4L2_CID_FLASH_CLASS_BASE))
 #define XLAT_STR_20 STRINGIFY(V4L2_CID_FLASH_CLASS_BASE)
 XLAT(V4L2_CID_JPEG_CLASS_BASE),
 #define XLAT_VAL_21 ((unsigned) (V4L2_CID_JPEG_CLASS_BASE))
 #define XLAT_STR_21 STRINGIFY(V4L2_CID_JPEG_CLASS_BASE)
 XLAT(V4L2_CID_IMAGE_SOURCE_CLASS_BASE),
 #define XLAT_VAL_22 ((unsigned) (V4L2_CID_IMAGE_SOURCE_CLASS_BASE))
 #define XLAT_STR_22 STRINGIFY(V4L2_CID_IMAGE_SOURCE_CLASS_BASE)
 XLAT(V4L2_CID_IMAGE_PROC_CLASS_BASE),
 #define XLAT_VAL_23 ((unsigned) (V4L2_CID_IMAGE_PROC_CLASS_BASE))
 #define XLAT_STR_23 STRINGIFY(V4L2_CID_IMAGE_PROC_CLASS_BASE)
 XLAT(V4L2_CID_DV_CLASS_BASE),
 #define XLAT_VAL_24 ((unsigned) (V4L2_CID_DV_CLASS_BASE))
 #define XLAT_STR_24 STRINGIFY(V4L2_CID_DV_CLASS_BASE)
 XLAT(V4L2_CID_FM_RX_CLASS_BASE),
 #define XLAT_VAL_25 ((unsigned) (V4L2_CID_FM_RX_CLASS_BASE))
 #define XLAT_STR_25 STRINGIFY(V4L2_CID_FM_RX_CLASS_BASE)
 XLAT(V4L2_CID_RF_TUNER_CLASS_BASE),
 #define XLAT_VAL_26 ((unsigned) (V4L2_CID_RF_TUNER_CLASS_BASE))
 #define XLAT_STR_26 STRINGIFY(V4L2_CID_RF_TUNER_CLASS_BASE)
 XLAT(V4L2_CID_DETECT_CLASS_BASE),
 #define XLAT_VAL_27 ((unsigned) (V4L2_CID_DETECT_CLASS_BASE))
 #define XLAT_STR_27 STRINGIFY(V4L2_CID_DETECT_CLASS_BASE)
 XLAT(V4L2_CID_CODEC_STATELESS_BASE),
 #define XLAT_VAL_28 ((unsigned) (V4L2_CID_CODEC_STATELESS_BASE))
 #define XLAT_STR_28 STRINGIFY(V4L2_CID_CODEC_STATELESS_BASE)
};
