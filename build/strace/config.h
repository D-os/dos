...
/* Define to 1 if you have the declaration of `CTL_APPLDATA', and to 0 if you
   don't. */
...
/* Define to 1 if you have the declaration of `CTL_INOTIFY', and to 0 if you
   don't. */
...
/* Define to 1 if you have the declaration of `IEEE802154_ADDR_LONG', and to 0
   if you don't. */
#define HAVE_DECL_IEEE802154_ADDR_LONG 0

/* Define to 1 if you have the declaration of `IEEE802154_ADDR_NONE', and to 0
   if you don't. */
#define HAVE_DECL_IEEE802154_ADDR_NONE 0

/* Define to 1 if you have the declaration of `IEEE802154_ADDR_SHORT', and to
   0 if you don't. */
...
/* Define to 1 if you have the declaration of `KERN_CAP_BSET', and to 0 if you
   don't. */
...
/* Define to 1 if you have the declaration of `KERN_JAVA_APPLETVIEWER', and to
   0 if you don't. */
#define HAVE_DECL_KERN_JAVA_APPLETVIEWER 0

/* Define to 1 if you have the declaration of `KERN_JAVA_INTERPRETER', and to
   0 if you don't. */
#define HAVE_DECL_KERN_JAVA_INTERPRETER 0

/* Define to 1 if you have the declaration of `KERN_MAXFILE', and to 0 if you
   don't. */
#define HAVE_DECL_KERN_MAXFILE 0

/* Define to 1 if you have the declaration of `KERN_MAXID', and to 0 if you
   don't. */
#define HAVE_DECL_KERN_MAXID 0

/* Define to 1 if you have the declaration of `KERN_MAXINODE', and to 0 if you
   don't. */
...
/* Define to 1 if you have the declaration of `KERN_NFSRADDRS', and to 0 if
   you don't. */
#define HAVE_DECL_KERN_NFSRADDRS 0

/* Define to 1 if you have the declaration of `KERN_NFSRNAME', and to 0 if you
   don't. */
...
/* Define to 1 if you have the declaration of `KERN_NRFILE', and to 0 if you
   don't. */
#define HAVE_DECL_KERN_NRFILE 0

/* Define to 1 if you have the declaration of `KERN_NRINODE', and to 0 if you
   don't. */
...
/* Define to 1 if you have the declaration of `NET_TCP_BIC', and to 0 if you
   don't. */
...
/* Define to 1 if you have the declaration of `NET_TCP_BIC_FAST_CONVERGENCE',
   and to 0 if you don't. */
#define HAVE_DECL_NET_TCP_BIC_FAST_CONVERGENCE 0

/* Define to 1 if you have the declaration of `NET_TCP_BIC_LOW_WINDOW', and to
   0 if you don't. */
...
/* Define to 1 if you have the declaration of `NET_TCP_VEGAS', and to 0 if you
   don't. */
#define HAVE_DECL_NET_TCP_VEGAS 0

/* Define to 1 if you have the declaration of `NET_TCP_VEGAS_ALPHA', and to 0
   if you don't. */
#define HAVE_DECL_NET_TCP_VEGAS_ALPHA 0

/* Define to 1 if you have the declaration of `NET_TCP_VEGAS_BETA', and to 0
   if you don't. */
#define HAVE_DECL_NET_TCP_VEGAS_BETA 0

/* Define to 1 if you have the declaration of `NET_TCP_VEGAS_GAMMA', and to 0
   if you don't. */
#define HAVE_DECL_NET_TCP_VEGAS_GAMMA 0

/* Define to 1 if you have the declaration of `NET_TCP_WESTWOOD', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `NFEA_ACTIVITY_NOTIFY', and to 0
   if you don't. */
#define HAVE_DECL_NFEA_ACTIVITY_NOTIFY 0

/* Define to 1 if you have the declaration of `NFEA_DONT_REFRESH', and to 0 if
   you don't. */
#define HAVE_DECL_NFEA_DONT_REFRESH 0

/* Define to 1 if you have the declaration of `NFEA_UNSPEC', and to 0 if you
   don't. */
#define HAVE_DECL_NFEA_UNSPEC 0

/* Define to 1 if you have the declaration of `PTP_PF_EXTTS', and to 0 if you
   don't. */
#define HAVE_DECL_PTP_PF_EXTTS 0

/* Define to 1 if you have the declaration of `PTP_PF_NONE', and to 0 if you
   don't. */
#define HAVE_DECL_PTP_PF_NONE 0

/* Define to 1 if you have the declaration of `PTP_PF_PEROUT', and to 0 if you
   don't. */
#define HAVE_DECL_PTP_PF_PEROUT 0

/* Define to 1 if you have the declaration of `PTP_PF_PHYSYNC', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `VM_CMM_PAGES', and to 0 if you
   don't. */
#define HAVE_DECL_VM_CMM_PAGES 0

/* Define to 1 if you have the declaration of `VM_CMM_TIMED_PAGES', and to 0
   if you don't. */
#define HAVE_DECL_VM_CMM_TIMED_PAGES 0

/* Define to 1 if you have the declaration of `VM_CMM_TIMEOUT', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `VM_DROP_PAGECACHE', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `VM_MIN_SLAB', and to 0 if you
   don't. */
#define HAVE_DECL_VM_MIN_SLAB 1

/* Define to 1 if you have the declaration of `VM_MIN_UNMAPPED', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `VM_PANIC_ON_OOM', and to 0 if
   you don't. */
#define HAVE_DECL_VM_PANIC_ON_OOM 1

/* Define to 1 if you have the declaration of `VM_PERCPU_PAGELIST_FRACTION',
   and to 0 if you don't. */
...
/* Define to 1 if you have the declaration of `VM_UNUSED1', and to 0 if you
   don't. */
#define HAVE_DECL_VM_UNUSED1 1

/* Define to 1 if you have the declaration of `VM_UNUSED2', and to 0 if you
   don't. */
#define HAVE_DECL_VM_UNUSED2 1

/* Define to 1 if you have the declaration of `VM_UNUSED3', and to 0 if you
   don't. */
#define HAVE_DECL_VM_UNUSED3 1

/* Define to 1 if you have the declaration of `VM_UNUSED4', and to 0 if you
   don't. */
#define HAVE_DECL_VM_UNUSED4 1

/* Define to 1 if you have the declaration of `VM_UNUSED5', and to 0 if you
   don't. */
#define HAVE_DECL_VM_UNUSED5 1

/* Define to 1 if you have the declaration of `VM_UNUSED7', and to 0 if you
   don't. */
#define HAVE_DECL_VM_UNUSED7 1

/* Define to 1 if you have the declaration of `VM_UNUSED8', and to 0 if you
   don't. */
#define HAVE_DECL_VM_UNUSED8 1

/* Define to 1 if you have the declaration of `VM_UNUSED9', and to 0 if you
   don't. */
#define HAVE_DECL_VM_UNUSED9 1

/* Define to 1 if you have the declaration of `VM_VDSO_ENABLED', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `VM_ZONE_RECLAIM_MODE', and to 0
   if you don't. */
#define HAVE_DECL_VM_ZONE_RECLAIM_MODE 1

/* Define to 1 if you have the declaration of `XFRM_MSG_ACQUIRE', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_ACQUIRE 1

/* Define to 1 if you have the declaration of `XFRM_MSG_ALLOCSPI', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_ALLOCSPI 1

/* Define to 1 if you have the declaration of `XFRM_MSG_DELPOLICY', and to 0
   if you don't. */
#define HAVE_DECL_XFRM_MSG_DELPOLICY 1

/* Define to 1 if you have the declaration of `XFRM_MSG_DELSA', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_DELSA 1

/* Define to 1 if you have the declaration of `XFRM_MSG_EXPIRE', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_EXPIRE 1

/* Define to 1 if you have the declaration of `XFRM_MSG_FLUSHPOLICY', and to 0
   if you don't. */
#define HAVE_DECL_XFRM_MSG_FLUSHPOLICY 1

/* Define to 1 if you have the declaration of `XFRM_MSG_FLUSHSA', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_FLUSHSA 1

/* Define to 1 if you have the declaration of `XFRM_MSG_GETAE', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `XFRM_MSG_GETSA', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_GETSA 1

/* Define to 1 if you have the declaration of `XFRM_MSG_GETSADINFO', and to 0
   if you don't. */
#define HAVE_DECL_XFRM_MSG_GETSADINFO 1

/* Define to 1 if you have the declaration of `XFRM_MSG_GETSPDINFO', and to 0
   if you don't. */
#define HAVE_DECL_XFRM_MSG_GETSPDINFO 1

/* Define to 1 if you have the declaration of `XFRM_MSG_MAPPING', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_MAPPING 1

/* Define to 1 if you have the declaration of `XFRM_MSG_MIGRATE', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_MIGRATE 1

/* Define to 1 if you have the declaration of `XFRM_MSG_NEWAE', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_NEWAE 1

/* Define to 1 if you have the declaration of `XFRM_MSG_NEWPOLICY', and to 0
   if you don't. */
#define HAVE_DECL_XFRM_MSG_NEWPOLICY 1

/* Define to 1 if you have the declaration of `XFRM_MSG_NEWSA', and to 0 if
   you don't. */
#define HAVE_DECL_XFRM_MSG_NEWSA 1

/* Define to 1 if you have the declaration of `XFRM_MSG_NEWSADINFO', and to 0
   if you don't. */
#define HAVE_DECL_XFRM_MSG_NEWSADINFO 1

/* Define to 1 if you have the declaration of `XFRM_MSG_NEWSPDINFO', and to 0
   if you don't. */
#define HAVE_DECL_XFRM_MSG_NEWSPDINFO 1

/* Define to 1 if you have the declaration of `XFRM_MSG_POLEXPIRE', and to 0
   if you don't. */
#define HAVE_DECL_XFRM_MSG_POLEXPIRE 1

/* Define to 1 if you have the declaration of `XFRM_MSG_REPORT', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `XFRM_MSG_UPDSA', and to 0 if
   you don't. */
...
/* Define to 1 if you have the <linux/if_xdp.h> header file. */
...
/* Define to 1 if you have mx32 mpers support */
...
/* Define to 1 if `si_lower' is a member of `siginfo_t'. */
#define HAVE_SIGINFO_T_SI_LOWER 1

/* Define to 1 if `si_overrun' is a member of `siginfo_t'. */
#define HAVE_SIGINFO_T_SI_OVERRUN 1

/* Define to 1 if `si_perf_data' is a member of `siginfo_t'. */
/* #undef HAVE_SIGINFO_T_SI_PERF_DATA */

/* Define to 1 if `si_perf_flags' is a member of `siginfo_t'. */
/* #undef HAVE_SIGINFO_T_SI_PERF_FLAGS */

/* Define to 1 if `si_perf_type' is a member of `siginfo_t'. */
/* #undef HAVE_SIGINFO_T_SI_PERF_TYPE */

/* Define to 1 if `si_pkey' is a member of `siginfo_t'. */
...
/* Define to 1 if `si_upper' is a member of `siginfo_t'. */
...
/* Define to 1 if `map_extra' is a member of `struct bpf_map_info'. */
...
/* Define to 1 if `pad' is a member of `struct bpf_map_info'. */
...
/* Define to 1 if `recursion_misses' is a member of `struct bpf_prog_info'. */
...
/* Define to 1 if `verified_insns' is a member of `struct bpf_prog_info'. */
...
/* Define to 1 if the system has the type `struct kbdiacrsuc'. */
#define HAVE_STRUCT_KBDIACRSUC 1

/* Define to 1 if the system has the type `struct kbdiacruc'. */
...
/* Define to 1 if the system has the type `struct sockaddr_alg_new'. */
...
/* Define to 1 if the system has the type `struct sockaddr_vm'. */
#define HAVE_STRUCT_SOCKADDR_VM 1

/* Define to 1 if `svm_flags' is a member of `struct sockaddr_vm'. */
#define HAVE_STRUCT_SOCKADDR_VM_SVM_FLAGS 1

/* Define to 1 if the system has the type `struct sockaddr_xdp'. */
...
/* Define to 1 if the system has the type `struct tcp_diag_md5sig'. */
/* #undef HAVE_STRUCT_TCP_DIAG_MD5SIG */
...
/* Define to 1 if `fd_array' is a member of `union bpf_attr'. */
...
/* Define to 1 if `link_create.addrs' is a member of `union bpf_attr'. */
...
/* Define to 1 if `link_create.bpf_cookie' is a member of `union bpf_attr'. */
/* #undef HAVE_UNION_BPF_ATTR_LINK_CREATE_BPF_COOKIE */

/* Define to 1 if `link_create.cnt' is a member of `union bpf_attr'. */
/* #undef HAVE_UNION_BPF_ATTR_LINK_CREATE_CNT */

/* Define to 1 if `link_create.cookies' is a member of `union bpf_attr'. */
...
/* Define to 1 if `link_create.iter_info' is a member of `union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_LINK_CREATE_ITER_INFO 1

/* Define to 1 if `link_create.iter_info_len' is a member of `union bpf_attr'.
   */
#define HAVE_UNION_BPF_ATTR_LINK_CREATE_ITER_INFO_LEN 1

/* Define to 1 if `link_create.kprobe_multi' is a member of `union bpf_attr'.
   */
#define HAVE_UNION_BPF_ATTR_LINK_CREATE_KPROBE_MULTI 1

/* Define to 1 if `link_create.perf_event' is a member of `union bpf_attr'. */
...
/* Define to 1 if `link_create.syms' is a member of `union bpf_attr'. */
/* #undef HAVE_UNION_BPF_ATTR_LINK_CREATE_SYMS */

/* Define to 1 if `link_create.target_btf_id' is a member of `union bpf_attr'.
   */
...
/* Define to 1 if `link_id' is a member of `union bpf_attr'. */
...
/* Define to 1 if `map_extra' is a member of `union bpf_attr'. */
...
/* Define to 1 if `pad' is a member of `union bpf_attr'. */
...
/* Define to 1 if `test.batch_size' is a member of `union bpf_attr'. */
#define HAVE_UNION_BPF_ATTR_TEST_BATCH_SIZE 1

/* Define to 1 if `test.cpu' is a member of `union bpf_attr'. */
...
/* Define to 1 if `test.flags' is a member of `union bpf_attr'. */
...
/* Define for the 64-bit LoongArch architecture. */
/* #undef LOONGARCH64 */
...
#define PACKAGE_STRING "strace 6.0.0.6.2ab6c"
...
#define PACKAGE_VERSION "6.0.0.6.2ab6c"
...
/* Date */
#define STRACE_MANPAGE_DATE "2022-10-16"
